...
if __name__ == '__main__':
    ...
    Formatter.format({'Cuphead': 1, 'Mugman': 3})  # Formatter.format({'Cuphead': 1, 'Mugman': 3})
    Formatter.format({1: 'one', 2: 'two'})  # Formatter.format({1: 'one', 2: 'two'})
    Formatter.format({1: True, 0: False})  # Formatter.format({1: True, 0: False})
    try:
